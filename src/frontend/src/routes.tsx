...
const router = createBrowserRouter(
  createRoutesFromElements([
    <Route path={ENABLE_CUSTOM_PARAM ? "/:customParam?" : "/"} element={
        <ContextWrapper>
          <Outlet />
        </ContextWrapper>
      }
            ...
            <Route path="" element={<AppAuthenticatedPage />}>
              <Route path="" element={<DashboardWrapperPage />}>
                <Route path="" element={<HomePage />}>
                  ...
                  />
                  <Route path="flows/" element={<MyCollectionComponent key="flows" type="flow" />}
                  >
                  ...
                  >
                    <Route path="folder/:folderId" element={<MyCollectionComponent key="all" type="all" />}
                    />
                  </Route>
                </Route>
                <Route path="settings" element={<SettingsPage />}>
                  ...
                  <Route path="general/:scrollId?" element={
                      <AuthSettingsGuard>
                        <GeneralPage />
                      </AuthSettingsGuard>
                    }
