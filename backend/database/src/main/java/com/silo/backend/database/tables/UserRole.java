...
import com.silo.backend.database.tables.records.UserRoleRecord;
...
public class UserRole extends TableImpl<UserRoleRecord> {
     ...
     */
    public final TableField<UserRoleRecord, String> USER_NAME = createField(DSL.name("user_name"), SQLDataType.VARCHAR(255).nullable(false), this, "");
