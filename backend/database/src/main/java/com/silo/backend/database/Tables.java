...
public class Tables {
     ...
     */
    public static final ApplicationComponent APPLICATION_COMPONENT = ApplicationComponent.APPLICATION_COMPONENT;

    /**
     * represents an ad-hoc collection of applications
     */
    public static final ApplicationGroup APPLICATION_GROUP = ApplicationGroup.APPLICATION_GROUP;

    /**
     * a reference to a specific application in a group
     */
    public static final ApplicationGroupEntry APPLICATION_GROUP_ENTRY = ApplicationGroupEntry.APPLICATION_GROUP_ENTRY;

    /**
     * users granted viewer or ownership rights to app groups
     */
    public static final ApplicationGroupMember APPLICATION_GROUP_MEMBER = ApplicationGroupMember.APPLICATION_GROUP_MEMBER;

    /**
     * app groups can include reference to org units. Apps associated to the org
     * unit are included in the group at runtime
     */
    public static final ApplicationGroupOuEntry APPLICATION_GROUP_OU_ENTRY = ApplicationGroupOuEntry.APPLICATION_GROUP_OU_ENTRY;

    /**
     * The table <code>application_relationship</code>.
     */
    public static final ApplicationRelationship APPLICATION_RELATIONSHIP = ApplicationRelationship.APPLICATION_RELATIONSHIP;

    /**
     * a score of a given complexity kind for an entity in waltz
     */
    public static final Complexity COMPLEXITY = Complexity.COMPLEXITY;
     ...
     */
    public static final ComplexityKind COMPLEXITY_KIND = ComplexityKind.COMPLEXITY_KIND;

    /**
     * The table <code>custom_environment</code>.
     */
    public static final CustomEnvironment CUSTOM_ENVIRONMENT = CustomEnvironment.CUSTOM_ENVIRONMENT;

    /**
     * The table <code>custom_environment_usage</code>.
     */
    public static final CustomEnvironmentUsage CUSTOM_ENVIRONMENT_USAGE = CustomEnvironmentUsage.CUSTOM_ENVIRONMENT_USAGE;

    /**
     * The table <code>database_information</code>.
     */
    public static final DatabaseInformation DATABASE_INFORMATION = DatabaseInformation.DATABASE_INFORMATION;

    /**
     * The table <code>database_usage</code>.
     */
    public static final DatabaseUsage DATABASE_USAGE = DatabaseUsage.DATABASE_USAGE;
     ...
     */
    public static final InvolvementGroup INVOLVEMENT_GROUP = InvolvementGroup.INVOLVEMENT_GROUP;

    /**
     * describes the association of an involvement kind to an involvement group
     */
    public static final InvolvementGroupEntry INVOLVEMENT_GROUP_ENTRY = InvolvementGroupEntry.INVOLVEMENT_GROUP_ENTRY;

    /**
     * defines a particular type of involvement a person may have in relation to
     * an entity (e.g. IT Owner for an APPLICATION)
     */
    public static final InvolvementKind INVOLVEMENT_KIND = InvolvementKind.INVOLVEMENT_KIND;

    /**
     * Key Involvement Kind For Entity Kind
     */
    public static final KeyInvolvementKind KEY_INVOLVEMENT_KIND = KeyInvolvementKind.KEY_INVOLVEMENT_KIND;

    /**
     * The table <code>organisational_unit</code>.
     */
    public static final OrganisationalUnit ORGANISATIONAL_UNIT = OrganisationalUnit.ORGANISATIONAL_UNIT;
     ...
     * permission group
     */
    public static final PermissionGroupEntry PERMISSION_GROUP_ENTRY = PermissionGroupEntry.PERMISSION_GROUP_ENTRY;

    /**
     * links a group of involvements to a given operation on an entity kind
     */
    public static final PermissionGroupInvolvement PERMISSION_GROUP_INVOLVEMENT = PermissionGroupInvolvement.PERMISSION_GROUP_INVOLVEMENT;
     ...
     */
    public static final PersonHierarchy PERSON_HIERARCHY = PersonHierarchy.PERSON_HIERARCHY;

    /**
     * Describes types of relationships between entities
     */
    public static final RelationshipKind RELATIONSHIP_KIND = RelationshipKind.RELATIONSHIP_KIND;
     ...
     */
    public static final ServerInformation SERVER_INFORMATION = ServerInformation.SERVER_INFORMATION;

    /**
     * The table <code>server_usage</code>.
     */
    public static final ServerUsage SERVER_USAGE = ServerUsage.SERVER_USAGE;
     ...
     */
    public static final UserAgentInfo USER_AGENT_INFO = UserAgentInfo.USER_AGENT_INFO;
